...
describe("Cypress Actions", () => {
  ...
  it("Checkbox & Radio Buttons - check() 3", () => {   // check/uncheck ==> inputs ONLY
    /**
     * 1. Check on the Java radio button
     * 2. Then Validate its checked
     * 3. Uncheck the JavaScript radio button
     * 4. Validate its check while Java is unchecked 
     */
  ...
  it("Checkbox & Radio Buttons - check() 4 - Multiple Elements", () => { 
    ...
    .each((ele) => { // .each() Cypress method === .forEach() JS array method [another useful tactic]
       // We can clearly use some JS methods to loop through and do repetitive tasks like checking these radio buttons 
      // cy.log(ele.attr('type')) --> loop through each option and returns the type of our attributes
     // cy.log(ele.attr('id')) --> loop through each option and returns the type of our ids [definitely could be useful]
